...
They will not be displayed because (1930...1951) is an exclusive range, meaning the higher end number that defines the range is not included in the range. The lower end number is included.

In this case the number 1930 is included and 1951 is not included.

a = (1930...1951).to_a is same as a = *[1930...1951]
splat operator :It splits the elements of the array into single items which are returned as a group.
