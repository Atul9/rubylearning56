...
participants who have not attempted Quiz 1 (is it so scary ?). A student writes
a clever Ruby program that creates an array of 0's and 1's. 0's indicate that
the participant has not attempted the Quiz and the 1's have attempted it.
...
puts "The number of participants who did not attempt Quiz 1 is #{quiz.select{|a| a == 0}.count} out of #{quiz.count} total participants"
